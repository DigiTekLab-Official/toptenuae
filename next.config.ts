...
const nextConfig: NextConfig = {
  ...
  // ============================================================================
  // 4. REWRITES (THE CACHE FIX)
  // ============================================================================
  // This forces /sitemap.xml to be served by the dynamic API route,
  // bypassing the stale static file cache on Cloudflare.
  async rewrites() {
    return [
      {
        source: '/sitemap.xml',
  ...
  async redirects() {
    return [
      // ... Your existing redirects (keep them exactly as they were) ...

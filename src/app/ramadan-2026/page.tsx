      ...
      <section className="container mx-auto px-4 -mt-8 relative z-20">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white p-6 rounded-2xl shadow-xl border border-gray-100 flex items-start gap-4">
            ...
            <div>
              <h3 className="text-sm font-bold text-gray-500 uppercase tracking-wider">Expected Start</h3>
              <p className="text-xl font-black text-gray-900 mt-1">Tue, Feb 17, 2026</p>
              <p className="text-xs text-gray-400 mt-1">Subject to moon sighting</p>
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-2xl shadow-xl border border-gray-100 flex items-start gap-4">
            ...
            <div>
              <h3 className="text-sm font-bold text-gray-500 uppercase tracking-wider">Fasting Hours</h3>
              <p className="text-xl font-black text-gray-900 mt-1">13–14 Hours</p>
              <p className="text-xs text-gray-400 mt-1">Fajr to Maghrib</p>
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-2xl shadow-xl border border-gray-100 flex items-start gap-4">
            ...
            <div>
              <h3 className="text-sm font-bold text-gray-500 uppercase tracking-wider">Eid Al Fitr</h3>
              <p className="text-xl font-black text-gray-900 mt-1">~ March 19, 2026</p>
              <Link href="/events-holidays/uae-holidays-2026" className="text-xs font-bold text-emerald-600 hover:underline mt-1 block">
              ...
              <table className="min-w-full divide-y divide-gray-200 bg-white">
                <thead className="bg-gray-50">
                  <tr>
                    ...
                    <th className="px-6 py-3 text-left text-xs font-bold text-gray-500 uppercase tracking-wider">Fajr (Suhoor Ends)</th>
                    <th className="px-6 py-3 text-left text-xs font-bold text-gray-500 uppercase tracking-wider">Maghrib (Iftar)</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-200">
                  <tr className="hover:bg-gray-50">
                    <td className="px-6 py-4 text-sm font-medium text-gray-900">Beginning (Feb 17)</td>
                    <td className="px-6 py-4 text-sm text-gray-600">05:25 AM</td>
                    <td className="px-6 py-4 text-sm text-gray-600">06:15 PM</td>
                  </tr>
                  <tr className="hover:bg-gray-50">
                    <td className="px-6 py-4 text-sm font-medium text-gray-900">Middle (Mar 3)</td>
                    <td className="px-6 py-4 text-sm text-gray-600">05:10 AM</td>
                    <td className="px-6 py-4 text-sm text-gray-600">06:22 PM</td>
                  </tr>
                  <tr className="hover:bg-gray-50">
                    <td className="px-6 py-4 text-sm font-medium text-gray-900">End (Mar 18)</td>
                    <td className="px-6 py-4 text-sm text-gray-600">04:55 AM</td>
                    <td className="px-6 py-4 text-sm text-gray-600">06:30 PM</td>
                  </tr>
                </tbody>
              </table>
            </div>
            <p className="text-xs text-gray-500 mt-2">*Timings are approximate for Dubai and may vary by +/- 3 minutes for Abu Dhabi and Sharjah.</p>
          </section>
            ...
            <div className="bg-white p-6 rounded-2xl border border-gray-200 hover:shadow-md transition-shadow flex flex-col">
              ...
              <div className="flex flex-col gap-3 mt-auto">
                <Link 
                  ...
                  className="flex items-center justify-center gap-2 w-full py-2.5 bg-red-50 text-red-700 font-bold rounded-xl text-sm hover:bg-red-100 transition-colors"
                >
                  <CalculatorIcon className="w-4 h-4" /> Use Zakat Calculator
                </Link>
                <Link 
                  href="/how-to-guides/how-to-pay-zakat-in-uae-online" 
                  className="text-center text-xs font-bold text-gray-500 hover:text-red-600"
                >
          ...
          <section className="relative overflow-hidden bg-gradient-to-r from-orange-500 to-amber-500 rounded-2xl shadow-lg text-white">
            ...
            <div className="relative z-10 p-6 md:p-10 flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="text-center md:text-left">
                <div className="inline-block bg-white/20 backdrop-blur-sm px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider mb-3">
                  Early Access
                </div>
                ...
                <div className="flex flex-wrap gap-3 justify-center md:justify-start">
                  <div className="bg-white text-orange-600 px-4 py-2 rounded-lg font-bold text-sm flex items-center gap-2 shadow-sm">
        ...
        <aside className="lg:col-span-4 space-y-6">
          <div className="sticky top-24">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
              ...
              <div className="space-y-6">
                ...
                <Link href="/finance-tools/zakat-calculator" className="group block">
                  <span className="text-xs font-bold text-[#4b0082] mb-1 block flex items-center gap-1">
                ...
                <Link href="/how-to-guides/how-to-pay-zakat-in-uae-online" className="group block border-t border-gray-100 pt-4">
                  <span className="text-xs font-bold text-emerald-600 mb-1 block">Step-by-Step Guide</span>
                  <h4 className="text-gray-900 font-bold leading-snug group-hover:text-[#4b0082] transition-colors">
                ...
                <Link href="/events-holidays/eid-al-fitr-uae-prayer-timings-free-events" className="group block border-t border-gray-100 pt-4">
                  <span className="text-xs font-bold text-purple-600 mb-1 block">Eid Al Fitr</span>
                  <h4 className="text-gray-900 font-bold leading-snug group-hover:text-[#4b0082] transition-colors">
                ...
                <Link href="/events-holidays/uae-holidays-2026" className="group block border-t border-gray-100 pt-4">
                  <span className="text-xs font-bold text-amber-500 mb-1 block">Planning Ahead</span>
                  <h4 className="text-gray-900 font-bold leading-snug group-hover:text-[#4b0082] transition-colors">
            ...
            <div className="bg-[#4b0082] p-6 rounded-2xl shadow-lg text-center mt-6">
              ...
              <p className="text-purple-200 text-sm mb-4">Get the best offers delivered to your inbox.</p>
              <Link href="/subscribe" className="block w-full py-2 bg-white text-[#4b0082] font-bold rounded-lg text-sm hover:bg-gray-100 transition-colors">
                Subscribe Free
              </Link>
            </div>

...
import BudgetLaptopPurchaseOptions from "./BudgetLaptopPurchaseOptions";
...
export default function TopTenTemplate({ data }: { data: TopTenData }) {
  ...
  return (
    <div className="w-full min-w-0" data-affiliate-category={affiliateCategory}>
      ...
      {isCommercial && data.slug === 'best-laptop-under-1500-aed-uae' && (
        <BudgetLaptopPurchaseOptions items={items} category={affiliateCategory} />
      )}

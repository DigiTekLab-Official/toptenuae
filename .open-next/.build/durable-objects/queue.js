...
// node_modules/.pnpm/@opennextjs+cloudflare@1.14.7_next@16.0.10_@babel+core@7.28.5_react-dom@19.2.3_react@19_4cf6326c39b2e860d9c5a9c42efa5ab1/node_modules/@opennextjs/cloudflare/dist/api/durable-objects/queue.js
...
var DOQueueHandler = class extends DurableObject {
    ...
    try {
      ...
      response = await this.service.fetch(`${protocol}://${host}${url}`, {
        ...
        headers: {
          ...
          "x-prerender-revalidate": "ec912cdf7a8965d6dd8ed3584ab4ad1d",
          "x-isr": "1"
        },
  ...
  async addToFailedState(msg) {
    ...
    if (!this.disableSQLite) {
      this.sql.exec("INSERT OR REPLACE INTO failed_state (id, data, buildId) VALUES (?, ?, ?)", msg.MessageDeduplicationId, JSON.stringify(updatedFailedState), "qMGIvsCg7PijAia1URQpk");
    }
    await this.addAlarm();
  }
  async addAlarm() {
  ...
  async initState() {
    ...
    this.sql.exec("DELETE FROM failed_state WHERE buildId != ?", "qMGIvsCg7PijAia1URQpk");
    this.sql.exec("DELETE FROM sync WHERE buildId != ?", "qMGIvsCg7PijAia1URQpk");

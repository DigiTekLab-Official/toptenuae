...
// node_modules/.pnpm/@opennextjs+cloudflare@1.16.2_next@16.1.6_@babel+core@7.29.0_react-dom@19.2.3_react@19._042aa8c4142086090411aab037798c65/node_modules/@opennextjs/cloudflare/dist/api/durable-objects/queue.js
...
var DOQueueHandler = class extends DurableObject {
    ...
    try {
      ...
      response = await this.service.fetch(`${protocol}://${host}${url}`, {
        ...
        headers: {
          ...
          "x-prerender-revalidate": "f5a04476d08006b95c25c899b44e20d5",
          "x-isr": "1"
        },
  ...
  async addToFailedState(msg) {
    ...
    if (!this.disableSQLite) {
      this.sql.exec("INSERT OR REPLACE INTO failed_state (id, data, buildId) VALUES (?, ?, ?)", msg.MessageDeduplicationId, JSON.stringify(updatedFailedState), "0l0HEHUer7u9z1jFStNEN");
    }
    await this.addAlarm();
  }
  async addAlarm() {
  ...
  async initState() {
    ...
    this.sql.exec("DELETE FROM failed_state WHERE buildId != ?", "0l0HEHUer7u9z1jFStNEN");
    this.sql.exec("DELETE FROM sync WHERE buildId != ?", "0l0HEHUer7u9z1jFStNEN");

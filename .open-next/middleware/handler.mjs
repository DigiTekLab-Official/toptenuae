...
// node_modules/.pnpm/@opennextjs+aws@3.9.14_next@16.1.6_@babel+core@7.29.0_react-dom@19.2.3_react@19.2.3__react@19.2.3_/node_modules/@opennextjs/aws/dist/overrides/wrappers/cloudflare-edge.js
...
// node_modules/.pnpm/@opennextjs+aws@3.9.14_next@16.1.6_@babel+core@7.29.0_react-dom@19.2.3_react@19.2.3__react@19.2.3_/node_modules/@opennextjs/aws/dist/overrides/originResolver/pattern-env.js
...
// .next/server/edge/chunks/[root-of-the-server]__d0cb4223._.js
var require_root_of_the_server_d0cb4223 = __commonJS({
  ".next/server/edge/chunks/[root-of-the-server]__d0cb4223._.js"() {
    "use strict";
    (globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["chunks/[root-of-the-server]__d0cb4223._.js", 51615, (e, r, o) => {
      ...
      self._ENTRIES ||= {};
      let n = Promise.resolve().then(() => e.i(99346));
      n.catch(() => {
...
// .next/server/edge/chunks/b2b3e_next_dist_5305f7db._.js
var require_b2b3e_next_dist_5305f7db = __commonJS({
  ".next/server/edge/chunks/b2b3e_next_dist_5305f7db._.js"() {
    "use strict";
    (globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["chunks/b2b3e_next_dist_5305f7db._.js", 59173, (e, t, r) => {
      "use strict";
      var n = Object.defineProperty, i = Object.getOwnPropertyDescriptor, a = Object.getOwnPropertyNames, o = Object.prototype.hasOwnProperty, s = {}, l = { RequestCookies: () => g, ResponseCookies: () => m, parseCookie: () => d, parseSetCookie: () => p, stringifyCookie: () => c };
      ...
      function p(e2) {
        ...
        {
          var m2, b, v = { name: t2, value: decodeURIComponent(r2), domain: i2, ...a2 && { expires: new Date(a2) }, ...o2 && { httpOnly: true }, ..."string" == typeof s2 && { maxAge: Number(s2) }, path: l2, ...u2 && { sameSite: h.includes(m2 = (m2 = u2).toLowerCase()) ? m2 : void 0 }, ...c2 && { secure: true }, ...g2 && { priority: f.includes(b = (b = g2).toLowerCase()) ? b : void 0 }, ...p2 && { partitioned: true } };
          let e3 = {};
      ...
      (() => {
        "use strict";
        let r2, n, i, a, o;
        var s, l, u, c, d, p, h, f, g, m, b, v, _, w, y, x, S = { 491: (e2, t2, r3) => {
        ...
        E.ab = "/ROOT/node_modules/.pnpm/next@16.1.6_@babel+core@7.29.0_react-dom@19.2.3_react@19.2.3__react@19.2.3/node_modules/next/dist/compiled/@opentelemetry/api/";
        var R = {};
        ...
        } }), m = E(996), Object.defineProperty(R, "SamplingDecision", { enumerable: true, get: function() {
          return m.SamplingDecision;
        } }), b = E(357), Object.defineProperty(R, "SpanKind", { enumerable: true, get: function() {
          return b.SpanKind;
        } }), v = E(847), Object.defineProperty(R, "SpanStatusCode", { enumerable: true, get: function() {
      ...
      (() => {
        ...
        l.ab = "/ROOT/node_modules/.pnpm/next@16.1.6_@babel+core@7.29.0_react-dom@19.2.3_react@19.2.3__react@19.2.3/node_modules/next/dist/compiled/p-queue/";
        var u = {};
      ...
      var n = { 226: function(t2, r2) {
        !function(n2, i2) {
          "use strict";
          var a2 = "function", o = "undefined", s = "object", l = "string", u = "major", c = "model", d = "name", p = "type", h = "vendor", f = "version", g = "architecture", m = "console", b = "mobile", v = "tablet", _ = "smarttv", w = "wearable", y = "embedded", x = "Amazon", S = "Apple", O = "ASUS", E = "BlackBerry", R = "Browser", C = "Chrome", P = "Firefox", T = "Google", N = "Huawei", I = "Microsoft", k = "Motorola", M = "Opera", A = "Samsung", j = "Sharp", L = "Sony", D = "Xiaomi", q = "Zebra", U = "Facebook", $ = "Chromium OS", B = "Mac OS", V = function(e2, t3) {
            var r3 = {};
          ...
          if (J.VERSION = "1.0.35", J.BROWSER = W([d, f, u]), J.CPU = W([g]), J.DEVICE = W([c, h, p, m, b, _, v, w, y]), J.ENGINE = J.OS = W([d, f]), typeof r2 !== o) t2.exports && (r2 = t2.exports = J), r2.UAParser = J;
      ...
      function E(e2, t2, r2) {
        ...
        return !function e3(t3, r3, n3, u3, c2) {
          ...
          if (m2) return c2 = c2(t3), m2 = "" === u3 ? "." + O(t3, 0) : u3, a(c2) ? (n3 = "", null != m2 && (n3 = m2.replace(S, "$&/") + "/"), e3(c2, r3, n3, "", function(e4) {
            return e4;
          })) : null != c2 && (x(c2) && (d2 = c2, p2 = n3 + (null == c2.key || t3 && t3.key === c2.key ? "" : ("" + c2.key).replace(S, "$&/") + "/") + m2, c2 = y(d2.type, p2, d2.props)), r3.push(c2)), 1;
          m2 = 0;
          var b2 = "" === u3 ? "." : u3 + ":";
          if (a(t3)) for (var _2 = 0; _2 < t3.length; _2++) f2 = b2 + O(u3 = t3[_2], _2), m2 += e3(u3, r3, n3, f2, c2);
          else if ("function" == typeof (_2 = null === (h2 = t3) || "object" != typeof h2 ? null : "function" == typeof (h2 = v && h2[v] || h2["@@iterator"]) ? h2 : null)) for (t3 = _2.call(t3), _2 = 0; !(u3 = t3.next()).done; ) f2 = b2 + O(u3 = u3.value, _2++), m2 += e3(u3, r3, n3, f2, c2);
          else if ("object" === f2) {
      ...
      r.Activity = m, r.Children = { map: E, forEach: function(e2, t2, r2) {
        E(e2, function() {
...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      let v = Symbol("response"), _ = Symbol("passThrough"), w = Symbol("waitUntil");
      class y {
        constructor(e10, t2) {
      ...
      var A, j, L, D, q, U, $, B, V, W, H, G, X = e.i(59173);
      ...
      class F extends Request {
        constructor(e10, t2 = {}) {
          ...
          const n2 = new M(r2, { headers: m(this.headers), nextConfig: t2.nextConfig });
            ...
            switch (n3) {
              ...
              case "set":
                return (...i3) => {
                  ...
                  return a2 instanceof X.ResponseCookies && r2.set("x-middleware-set-cookie", a2.getAll().map((e12) => (0, X.stringifyCookie)(e12)).join(",")), Y(t2, o2), a2;
                };
              default:
                return K.get(e11, n3, i2);
            }
          } });
          this[Q] = { cookies: n2, url: t2.url ? new M(t2.url, { headers: m(r2), nextConfig: t2.nextConfig }) : void 0 };
        }
        [Symbol.for("edge-runtime.inspect.custom")]() {
      ...
      let eI = process.env.NEXT_OTEL_PERFORMANCE_PREFIX, { context: ek, propagation: eM, trace: eA, SpanStatusCode: ej, SpanKind: eL, ROOT_CONTEXT: eD } = t = e.r(96804);
      ...
      }, e$ = /* @__PURE__ */ new Map(), eB = t.createContextKey("next.rootSpanId"), eV = 0, eW = { set(e10, t2, r2) {
      ...
      let ti = { keys: (e10) => Array.from(e10.keys()), get: (e10, t2) => e10.get(t2) ?? void 0 }, ta = (e10, t2) => eH().withPropagatedContext(e10.headers, t2, ti), to = false;
      async function ts(t2) {
        var r2, n2, i2, a2;
        let o2, s2, u2, c2, d2;
        !function() {
          if (!to && (to = true, "true" === process.env.NEXT_PRIVATE_TEST_PROXY)) {
            let { interceptTestApis: t3, wrapRequestHandler: r3 } = e.r(51932);
            t3(), ta = r3(ta);
          }
        }(), await l();
        ...
        let g2 = function(e10) {
          ...
          return t3;
        }(t2.request.headers), m2 = g2.has("x-nextjs-data"), b2 = "1" === g2.get("rsc");
        m2 && "/index" === h2.pathname && (h2.pathname = "/");
        let v2 = /* @__PURE__ */ new Map();
        if (!p2) for (let e10 of er) {
          let t3 = g2.get(e10);
          null !== t3 && (v2.set(e10, t3), g2.delete(e10));
        }
        ...
        m2 && Object.defineProperty(y2, "__isData", { enumerable: false, value: true }), !globalThis.__incrementalCacheShared && t2.IncrementalCache && (globalThis.__incrementalCache = new t2.IncrementalCache({ CurCacheHandler: t2.incrementalCacheHandler, minimalMode: true, fetchCacheKeyPrefix: "", dev: false, requestHeaders: t2.request.headers, getPrerenderManifest: () => ({ version: -1, routes: {}, dynamicRoutes: {}, notFoundRoutes: [], preview: te() }) }));
        ...
        if ((o2 = await ta(y2, () => {
          if ("/middleware" === t2.page || "/src/middleware" === t2.page || "/proxy" === t2.page || "/src/proxy" === t2.page) {
            ...
            return eH().trace(eC.execute, { spanName: `middleware ${y2.method}`, attributes: { "http.target": y2.nextUrl.pathname, "http.method": y2.method } }, async () => {
              try {
                ...
                let c3 = te(), d3 = await tr("/", y2.nextUrl, null), p3 = (l2 = y2.nextUrl, u3 = (e11) => {
                  ...
                  return { type: "request", phase: e11, implicitTags: a4, url: { pathname: n4.pathname, search: n4.search ?? "" }, rootParams: i4, get headers() {
                    ...
                    if (!h4.cookies) {
                      let e12 = new X.RequestCookies(ea.from(t3.headers));
                    ...
                    if (!h4.mutableCookies) {
                      var f3, g3;
                      let e12, n5 = (f3 = t3.headers, g3 = o4 || (r4 ? p4 : void 0), e12 = new X.RequestCookies(ea.from(f3)), ef.wrap(e12, g3));
                    ...
                    if (!h4.userspaceMutableCookies) {
                      var m3;
                      let e12;
                      m3 = this, h4.userspaceMutableCookies = e12 = new Proxy(m3.mutableCookies, { get(t4, r5, n5) {
                        switch (r5) {
                          case "delete":
                            return function(...r6) {
        ...
        if (o2 && E2 && (b2 || !p2)) {
          ...
          !p2 && m2 && o2.headers.set("x-nextjs-rewrite", r3);
        ...
        if (o2 && R2 && !p2) {
          ...
          o2 = new Response(o2.body, o2), e10.host === h2.host && (e10.buildId = f2 || e10.buildId, o2.headers.set("Location", ee(e10, h2).url)), m2 && (o2.headers.delete("Location"), o2.headers.set("x-nextjs-redirect", ee(e10.toString(), h2.toString()).url));
        }
        let C2 = o2 || Z.next(), P2 = C2.headers.get("x-middleware-override-headers"), T2 = [];
        if (P2) {
          for (let [e10, t3] of v2) C2.headers.set(`x-middleware-request-${e10}`, t3), T2.push(e10);
      ...
      function tu(e10) {
        let t2 = e10.nextUrl.clone(), { pathname: r2, searchParams: n2 } = t2, i2 = e10.headers.get("host") || "";
        if (i2.startsWith("webmail.") || i2.startsWith("mail.") || i2.startsWith("cpanel.") || i2.startsWith("www.webmail.") || i2.startsWith("www.mail.")) return new Z("Forbidden", { status: 403 });
        if (r2.includes(".php") || r2.startsWith("/cgi-bin/") || r2.startsWith("/phpinfo") || "/docs/index.html" === r2 || r2.includes("/page_does_not_exist")) return new Z("Not Found", { status: 404 });
        if (r2.includes("://")) {
          let t3 = r2.replace(/^.*:\/\/[^/]+/, "");
          return Z.redirect(new URL(t3, e10.url), 301);
        }
        if (n2.has("s") && "" !== n2.get("s")) {
          let e11 = Z.next();
          return e11.headers.set("X-Robots-Tag", "noindex, nofollow"), e11;
        }
        let a2 = false, o2 = false;
        if (i2.startsWith("www.") && (t2.hostname = i2.replace("www.", ""), a2 = true, o2 = true), r2.startsWith("/category/") || r2.startsWith("/tag/") || r2.startsWith("/author/")) return new Z("Gone", { status: 410 });
        r2 !== r2.toLowerCase() && (t2.pathname = r2.toLowerCase(), a2 = true), (t2.pathname.includes("%20") || t2.pathname.includes(" ")) && (t2.pathname = t2.pathname.replace(/%20|\s+/g, "-").replace(/&/g, "and").replace(/-+/g, "-").toLowerCase(), a2 = true), (r2.endsWith("/feed") || r2.endsWith("/feed/")) && (t2.pathname = r2.replace(/\/feed\/?$/, ""), a2 = true), (r2.endsWith("/amp") || r2.endsWith("/amp/")) && (t2.pathname = r2.replace(/\/amp\/?$/, ""), a2 = true), ["noamp", "amp", "m", "feed", "cat", "fbclid", "gclid", "utm_source", "utm_medium", "utm_campaign", "utm_content", "utm_term"].forEach((e11) => {
          n2.has(e11) && (n2.delete(e11), a2 = true);
        }), r2.startsWith("/index.php/") && (t2.pathname = r2.replace("/index.php", ""), a2 = true);
        let s2 = "/" === t2.pathname, l2 = t2.pathname.endsWith("/");
        if (!s2 && l2 && (t2.pathname = t2.pathname.slice(0, -1), a2 = true), a2) {
          let r3 = new URL(t2.pathname + t2.search, e10.url), n3 = o2 ? 301 : 308;
          return Z.redirect(r3, n3);
        }
        let u2 = Z.next();
        return u2.headers.set("Strict-Transport-Security", "max-age=63072000; includeSubDomains; preload"), u2.headers.set("Cross-Origin-Opener-Policy", "same-origin-allow-popups"), n2.has("_rsc") && (u2.headers.set("Cache-Control", "private, no-cache, no-store, must-revalidate"), u2.headers.set("Vary", "RSC, Next-Router-State-Tree, Next-Router-Prefetch")), u2.headers.set("Content-Security-Policy", "default-src 'self'; script-src 'self' 'unsafe-eval' 'unsafe-inline' https://www.googletagmanager.com https://www.google-analytics.com https://www.clarity.ms https://*.clarity.ms https://static.cloudflareinsights.com https://challenges.cloudflare.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; img-src 'self' blob: data: https://cdn.sanity.io https://placehold.co https://toptenuae.com https://lh3.googleusercontent.com https://www.googletagmanager.com https://www.google-analytics.com https://*.clarity.ms https://c.bing.com https://m.media-amazon.com; font-src 'self' https://fonts.gstatic.com; connect-src 'self' https://cdn.sanity.io https://*.sanity.io https://www.google-analytics.com https://www.googletagmanager.com https://*.clarity.ms https://static.cloudflareinsights.com https://challenges.cloudflare.com; frame-src 'self' https://www.googletagmanager.com https://challenges.cloudflare.com; object-src 'none'; base-uri 'self'; form-action 'self'; upgrade-insecure-requests;"), u2.headers.set("X-Frame-Options", "SAMEORIGIN"), u2.headers.set("X-Content-Type-Options", "nosniff"), u2.headers.set("X-XSS-Protection", "1; mode=block"), u2.headers.set("Referrer-Policy", "strict-origin-when-cross-origin"), u2.headers.set("Permissions-Policy", "camera=(), microphone=(), geolocation=(), payment=(), usb=(), vr=()"), r2.match(/\.(jpg|jpeg|png|gif|svg|webp|avif|ico|css|js|woff|woff2|ttf|eot)$/) && u2.headers.set("Cache-Control", "public, max-age=31536000, immutable"), u2;
      }
      RegExp(`\\n\\s+at Suspense \\(<anonymous>\\)(?:(?!\\n\\s+at (?:body|div|main|section|article|aside|header|footer|nav|form|p|span|h1|h2|h3|h4|h5|h6) \\(<anonymous>\\))[\\s\\S])*?\\n\\s+at __next_root_layout_boundary__ \\([^\\n]*\\)`), RegExp(`\\n\\s+at __next_metadata_boundary__[\\n\\s]`), RegExp(`\\n\\s+at __next_viewport_boundary__[\\n\\s]`), RegExp(`\\n\\s+at __next_outlet_boundary__[\\n\\s]`), e.s([], 88648), e.i(88648), e.s(["config", 0, { matcher: ["/((?!api|_next/static|_next/image|_next/data|studio|favicon.ico|icon.svg|icon-v2.svg|apple-icon.png|robots.txt|sitemap.xml|.*\\.(?:svg|png|jpg|jpeg|gif|webp|ico|woff|woff2|ttf|eot|js|css|json)$).*)"] }, "middleware", () => tu], 99446);
      var tc = e.i(99446);
...
// .next/server/edge/chunks/f035a_next_dist_esm_build_templates_edge-wrapper_4dd6c933.js
var require_f035a_next_dist_esm_build_templates_edge_wrapper_4dd6c933 = __commonJS({
  ".next/server/edge/chunks/f035a_next_dist_esm_build_templates_edge-wrapper_4dd6c933.js"() {
    "use strict";
    (globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["chunks/f035a_next_dist_esm_build_templates_edge-wrapper_4dd6c933.js", { otherChunks: ["chunks/[root-of-the-server]__d0cb4223._.js", "chunks/b2b3e_next_dist_5305f7db._.js"], runtimeModuleIds: [60090] }]), (() => {
      let e;
...
// node_modules/.pnpm/@opennextjs+aws@3.9.14_next@16.1.6_@babel+core@7.29.0_react-dom@19.2.3_react@19.2.3__react@19.2.3_/node_modules/@opennextjs/aws/dist/core/edgeFunctionHandler.js
...
var init_edgeFunctionHandler = __esm({
  "node_modules/.pnpm/@opennextjs+aws@3.9.14_next@16.1.6_@babel+core@7.29.0_react-dom@19.2.3_react@19.2.3__react@19.2.3_/node_modules/@opennextjs/aws/dist/core/edgeFunctionHandler.js"() {
    ...
    globalThis._ROUTES = [{ "name": "middleware", "page": "/", "regex": ["^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!api|_next\\/static|_next\\/image|_next\\/data|studio|favicon.ico|icon.svg|icon-v2.svg|apple-icon.png|robots.txt|sitemap.xml|.*\\.(?:svg|png|jpg|jpeg|gif|webp|ico|woff|woff2|ttf|eot|js|css|json)$).*))(\\\\.json)?[\\/#\\?]?$"] }];
    require_root_of_the_server_d0cb4223();
    require_b2b3e_next_dist_5305f7db();
    require_f035a_next_dist_esm_build_templates_edge_wrapper_4dd6c933();
  }
});
...
// node_modules/.pnpm/@opennextjs+aws@3.9.14_next@16.1.6_@babel+core@7.29.0_react-dom@19.2.3_react@19.2.3__react@19.2.3_/node_modules/@opennextjs/aws/dist/adapters/middleware.js
init_logger();

// node_modules/.pnpm/@opennextjs+aws@3.9.14_next@16.1.6_@babel+core@7.29.0_react-dom@19.2.3_react@19.2.3__react@19.2.3_/node_modules/@opennextjs/aws/dist/core/createGenericHandler.js
init_logger();
...
var ConfigHeaders = [{ "source": "/:path*", "headers": [{ "key": "Strict-Transport-Security", "value": "max-age=63072000; includeSubDomains; preload" }, { "key": "X-DNS-Prefetch-Control", "value": "on" }, { "key": "X-Frame-Options", "value": "SAMEORIGIN" }, { "key": "X-Content-Type-Options", "value": "nosniff" }, { "key": "X-XSS-Protection", "value": "1; mode=block" }, { "key": "Referrer-Policy", "value": "strict-origin-when-cross-origin" }, { "key": "Permissions-Policy", "value": "camera=(), microphone=(), geolocation=()" }, { "key": "Link", "value": "<https://cdn.sanity.io>; rel=preconnect; crossorigin, <https://www.googletagmanager.com>; rel=preconnect" }], "regex": "^(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))?(?:/)?$" }, { "source": "/:path*", "headers": [{ "key": "Cross-Origin-Opener-Policy", "value": "same-origin-allow-popups" }, { "key": "Cross-Origin-Resource-Policy", "value": "same-site" }, { "key": "Cross-Origin-Embedder-Policy", "value": "unsafe-none" }], "regex": "^(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))?(?:/)?$" }, { "source": "/:path*", "has": [{ "type": "query", "key": "_rsc" }], "headers": [{ "key": "Cache-Control", "value": "private, no-cache, no-store, must-revalidate" }, { "key": "Vary", "value": "RSC, Next-Router-State-Tree, Next-Router-Prefetch" }], "regex": "^(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))?(?:/)?$" }, { "source": "/:all*(svg|jpg|jpeg|png|webp|avif|gif|ico|woff|woff2|ttf|eot)", "headers": [{ "key": "Cache-Control", "value": "public, max-age=31536000, immutable" }], "regex": "^(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))?(svg|jpg|jpeg|png|webp|avif|gif|ico|woff|woff2|ttf|eot)(?:/)?$" }];
...
// node_modules/.pnpm/@opennextjs+aws@3.9.14_next@16.1.6_@babel+core@7.29.0_react-dom@19.2.3_react@19.2.3__react@19.2.3_/node_modules/@opennextjs/aws/dist/utils/normalize-path.js
